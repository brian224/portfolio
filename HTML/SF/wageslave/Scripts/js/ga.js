if ( document.getElementById('gaScript') ) {
    var _gaId = document.getElementById('gaScript').dataset !== undefined ? ( document.getElementById('gaScript').dataset.id ? document.getElementById('gaScript').dataset.id : document.getElementById('gaScript').value ) : document.getElementById('gaScript').getAttribute('data-id');
    ...
    if ( _gaId ) {
        ...
        gaFn.prototype.pageview = function(gaId) {
            ga('create', gaId , 'auto');
